...
# `aliveben2k/genomics-workflows (Nextflow_version/nj-tree)`: Contributing guidelines

Hi there!
Thanks for taking an interest in improving aliveben2k/genomics-workflows (Nextflow_version/nj-tree).

This page describes the recommended nf-core way to contribute to both aliveben2k/genomics-workflows (Nextflow_version/nj-tree) and nf-core pipelines in general, including:

- [General contribution guidelines](#general-contribution-guidelines): common procedures or guides across all nf-core pipelines.
- [Pipeline-specific contribution guidelines](#pipeline-specific-contribution-guidelines): procedures or guides specific to the development conventions of aliveben2k/genomics-workflows (Nextflow_version/nj-tree).
...
- [ ] Check whether a GitHub [issue](https://github.com/aliveben2k/genomics-workflows/issues) about your idea already exists. If an issue does not exist, create one so that others are aware you are working on it.
- [ ] [Fork](https://help.github.com/en/github/getting-started-with-github/fork-a-repo) the [aliveben2k/genomics-workflows repository](https://github.com/aliveben2k/genomics-workflows) to your GitHub account.
...
You can contribute to aliveben2k/genomics-workflows (Nextflow_version/nj-tree) without installing a local development environment on your machine by using [GitHub Codespaces](https://github.com/codespaces).
...
To get started, open the repository in [Codespaces](https://github.com/aliveben2k/genomics-workflows/codespaces).
...
nf-core semi-standardises how you write code and other contributions to make the aliveben2k/genomics-workflows (Nextflow_version/nj-tree) code and processing logic more understandable for new contributors and to ensure quality.
...
Pipeline changes should include a Nextflow preview check and Python syntax validation.
