...
#output_file = "MATRIXTOPLOT.txt"  # You can change the file name as needed
np.savetxt('%s.%s'%(args.figure,'table.txt'), MATRIXTOPLOT, delimiter='\t', fmt='%.6f')  # Change precision as necessary
#print(f"MATRIXTOPLOT table has been exported to {output_file}")
